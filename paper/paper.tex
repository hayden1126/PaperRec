...
shot, but a single solve tells us nothing about how the walker
actually gets to the invariant distribution step by step.
Power iteration tracks this exact progression by applying the
Markov chain's transition rule repeatedly, and the rate at
which the iterates converge to $\mathbf{v}$ is what we set
out to predict in this section:
\begin{equation}
